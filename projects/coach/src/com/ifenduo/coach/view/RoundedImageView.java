...
import static com.ifenduo.coach.view.RoundedDrawable.CORNER_BOTTOM_LEFT;
import static com.ifenduo.coach.view.RoundedDrawable.CORNER_BOTTOM_RIGHT;
import static com.ifenduo.coach.view.RoundedDrawable.CORNER_TOP_LEFT;
import static com.ifenduo.coach.view.RoundedDrawable.CORNER_TOP_RIGHT;
...
public class RoundedImageView extends ImageView {
	...
	private void updateAttrs(Drawable drawable) {
		...
		if (drawable instanceof RoundedDrawable) {
			((RoundedDrawable) drawable).setScaleType(mScaleType).setBorderWidth(mBorderWidth).setBorderColor(mBorderColor).setOval(mIsOval).setTileModeX(mTileModeX).setTileModeY(mTileModeY);

			if (mCornerRadii != null) {
				((RoundedDrawable) drawable).setCornerRadius(mCornerRadii[CORNER_TOP_LEFT], mCornerRadii[CORNER_TOP_RIGHT], mCornerRadii[CORNER_BOTTOM_RIGHT], mCornerRadii[CORNER_BOTTOM_LEFT]);
			}
	...
	public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
		if (mCornerRadii[CORNER_TOP_LEFT] == topLeft && mCornerRadii[CORNER_TOP_RIGHT] == topRight && mCornerRadii[CORNER_BOTTOM_RIGHT] == bottomRight
